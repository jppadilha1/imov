...
**Reason:** Substituído por offline-first puro. Supabase não é mais fonte de leitura em tempo real.
**Migration:** Todas leituras agora vêm do SQLite. Supabase recebe dados via `SyncProspectosUseCase`.
